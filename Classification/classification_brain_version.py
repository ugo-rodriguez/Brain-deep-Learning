...
from brain_logger_for_classification import BrainNetImageLogger
...
def main():
    ...
    model = BrainIcoNet(nbr_features,dropout_lvl,image_size,noise_lvl,ico_lvl,batch_size, radius=radius,lr=lr)
